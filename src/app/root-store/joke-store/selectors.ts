...
export const selectJokeById = (id: string) => createSelector(this.selectAllJokeItems, (allJokes: Joke[])=>{
  if(allJokes){
...
export const selectJokeError: MemoizedSelector<object, any> =
  createSelector(
    selectJokeState,
    getError
  );

export const selectJokeIsLoading: MemoizedSelector<object, boolean> =
